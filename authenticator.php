...
<html lang="en">
<head>
    <title>Lab Activity - Authenticator</title>
    <meta charset="UTF-8">
        ...
        if ($result->num_rows > 0) {
            ...
            while($row = $result->fetch_assoc()) {
                ...
                if(($row["expiration"]) >($currentDate)){
                    ...
                    $sql1 = "INSERT INTO `userlog` (user_id, username, activity, dateandtime) VALUES ('$user_id', '$user_name', 'Entered Expired Code', '$currentDate')";
            ...
            echo "<p class='p'>Wrong code entered.</p>";
                    ...
                    $sql1 = "INSERT INTO `userlog` (user_id, username, activity, dateandtime) VALUES ('$user_id', '$user_name', 'Entered Wrong Code', '$currentDate')";
