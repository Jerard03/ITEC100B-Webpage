...
<body>
        ...
        <div class="form">
            ...
            <div class="container">
                ...
                <center>
                    ...
                    <button type="button" class="btn" name="register" onclick="window.location.href='../ITEC100B-Webpage/signup.php'">Register</button>
                </center>
                <!--<button type="button"  class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal" onclick="openWin()">Login</button>-->
                <h1><a href="../ITEC100B-Webpage/forgot.php"> FORGOT PASSWORD </a></h1>               
    ...
    <center>
        <button type="button" class="btn" name="register" onclick="window.location.href='../ITEC100B-Webpage/userlog.php'">USER LOG</button>
    </center>
                ...
                if(mysqli_stmt_num_rows($stmt) == 1){ 
                    ...
                    if(mysqli_stmt_fetch($stmt)){
                        if(password_verify($password, $hashed_password)){
                            ...
                            $link = "<script>window.open('http://localhost/ITEC100B-Webpage/authenticator.php')</script>"; 
                            echo $link; 
...
<?php
    ...
    if (isset($_POST['username'])){
        ...
        if($rows==1){
            ...
            header("location: ../ITEC100B-Webpage/authenticator.php");
